...
//Integer é o tipo do atributo identificador da classe Endereco, pois é o ID da classe.
//Endereco é o tipo do objeto, que no caso será do tipo Endereco.
//Agora, feito tudo isso, um objeto do tipo EnderecoRepository vai ser capaz de realizar 
